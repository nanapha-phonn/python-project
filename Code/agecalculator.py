...
def calculateAge():
    ...
    Label(text=f"{nameVarlue.get()} your age is {age}",font=30).place(x=300,y=500)
...
nameEntry=Entry(root,textvariable=nameValue,width30,bd=3,font=20)
nameEntry.place(x=300,y=250)

yearEntry=Entry(root,textvariable=yearValue,width30,bd=3,font=20)
yearEntry.place(x=300,y=300)

monthEntry=Entry(root,textvariable=nameValue,width30,bd=3,font=20)
monthEntry.place(x=300,y=350)

dayEntry=Entry(root,textvariable=nameValue,width30,bd=3,font=20)
